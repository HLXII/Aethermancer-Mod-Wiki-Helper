...
public static class ParseExtensions
{
    public static ActionData ToData(this BaseAction action, Monster monster)
    {
        ...
        data.Effect = ReformatDescription(action.GetDescription(skillInstance));
        try
        {
            data.Key = ParseForKeys(data.Effect);
        }
        catch (Exception ex)
        {
    ...
    public static TraitData ToData(this Trait trait, Monster monster)
    {
        ...
        data.Effect = ReformatDescription(trait.GetDescription(passiveInstance));
        try
        {
            data.Key = ParseForKeys(data.Effect);
        }
    ...
    private static List<string> ParseForKeys(string description)
    {
